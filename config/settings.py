...
# Add the 'apps' directory to the Python path for custom apps
...
# Installed apps - Use direct paths for now during transition
INSTALLED_APPS = [
	...
	'traffic_analysis.apps.TrafficAnalysisConfig',
	'django_q',
	'drf_yasg',
	# Custom apps
	'rest_framework',
	'authentication.apps.AuthenticationConfig',
	'okta_auth.apps.OktaAuthConfig',
	'login_tracking.apps.LoginTrackingConfig',  # Updated to use the app config class
	
	# Performance optimizations
	'django_prometheus',
	'okta_dashboard',  # Main site app that pulls it all together
]
...
MIDDLEWARE = [
	...
	"okta_dashboard.middleware.security_headers_func.security_headers_middleware",  # Using function-based middleware with async support
    ...
    # Update middleware to use direct paths during transition
    "authentication.middleware.secure_session.SecureSessionMiddleware",
    "authentication.middleware.continuous_auth.ContinuousAuthMiddleware",
    "authentication.middleware.api_authorization.APIAuthorizationMiddleware",
...
TEMPLATES = [
	{
		...
		"OPTIONS": {
			"context_processors": [
				...
				"okta_dashboard.context_processors.security.nonce_processor",  # Updated from core to okta_dashboard
			],
		},
	},
]
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [
    BASE_DIR / "apps/traffic_analysis/static",  # Corrected path for apps directory structure
    BASE_DIR / "apps/okta_auth/static",  # Corrected path for apps directory structure
]
