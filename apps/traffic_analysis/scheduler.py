...
def fetch_okta_logs_with_dpop():
    ...
    try:
        ...
        async_task(
            ...
            hook='traffic_analysis.scheduler.dpop_log_fetch_callback'
        )
...
def self_perpetuating_okta_logs_fetch():
    ...
    try:
        ...
        task_result = async_task(
            ...
            '--max-pages', '0',    # Unlimited pages
            '--limit', '1000',     # Maximum logs per request
            hook='traffic_analysis.scheduler.self_perpetuating_callback'
        )
...
def schedule_next_execution(delay_seconds=60):
    ...
    try:
        ...
        schedule(
            'traffic_analysis.scheduler.self_perpetuating_okta_logs_fetch',
            name=task_name,
...
def start_okta_logs_chain():
    ...
    try:
        ...
        Schedule.objects.filter(func='traffic_analysis.scheduler.self_perpetuating_okta_logs_fetch').delete()
