...
# Configure mongoengine as the only database
mongoengine.connect(
    db=os.getenv('MONGOENGINE_DB', 'okta_dashboard'),
    host=os.getenv('MONGODB_HOST', 'mongodb://localhost:27017/okta_dashboard'),
)
